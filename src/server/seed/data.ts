...
export const DEMO_IDEA_CAMPAIGN_ASSOCIATIONS = [
  {
    associationType: "submitted",
    campaignId: "general-campaign",
    clarificationAllowed: false,
    clarificationReason: null,
    clarificationRequestId: null,
    contextVersion: "seed-baseline",
    createdAt: "2026-01-15 10:30:00",
    fitBasis: "Original employee submission destination.",
    ideaId: "idea-general-material-exchange",
    id: "idea-association-general-material-exchange",
    routingBasis: "Initial General Campaign intake association.",
    sourceWorkflowState: "general_idea",
