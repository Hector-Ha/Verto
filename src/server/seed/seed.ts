...
import {
  ...
  DEMO_IDEA_CAMPAIGN_ASSOCIATIONS,
  DEMO_IDEA_STATES,
  DEMO_IDEAS,
...
export async function seedDemoData() {
  ...
  try {
    ...
    for (const association of DEMO_IDEA_CAMPAIGN_ASSOCIATIONS) {
      await connection.execute(
        `
          ...
          ON DUPLICATE KEY UPDATE
            ...
            source_workflow_state = VALUES(source_workflow_state),
            fit_basis = VALUES(fit_basis),
            routing_basis = VALUES(routing_basis),
            context_version = VALUES(context_version),
            clarification_allowed = VALUES(clarification_allowed),
            clarification_reason = VALUES(clarification_reason),
            clarification_request_id = VALUES(clarification_request_id),
            updated_at = VALUES(updated_at)
        `,
        [
          association.id,
          ...
          association.sourceWorkflowState,
          association.fitBasis,
          association.routingBasis,
          association.contextVersion,
          association.clarificationAllowed,
          association.clarificationReason,
